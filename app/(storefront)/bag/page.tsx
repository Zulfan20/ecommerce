    ...
    return (
        <div className="max-w-2xl mx-auto mt-10 min-h-[55vh]">
            {cart?.items.length === 0 ? (
                ...
                p-8 text-center mt-20">
                    <div className="flex h-20 w-20  items-center justify-center rounded-full bg-primary/10">
                        <ShoppingBag  className="w-10 h-10 text-primary" />
                    </div>
                    <h2 className="mt-6  text-xl font-semibold">you don't have any item in your bag</h2>
                    <p
                    className="mb-8 mt-2 text-center text-sm leading-6 text-muted-background max-w-sm mx-auto"
                    >please add some items so that you can see yourt items here</p>
                    <Button asChild>
